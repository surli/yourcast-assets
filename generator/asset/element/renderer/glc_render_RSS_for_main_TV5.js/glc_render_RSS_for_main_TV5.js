...
/*
 * work on rss feed source TV5
 */
function render_RSS_for_main_TV5(collection, zone, timeInfo){
	timeInfo = typeof timeInfo !== 'undefined' ? timeInfo : 5;
	return render_RSS_for_main(collection, zone, "img/logos/TV5.png", timeInfo);
}
