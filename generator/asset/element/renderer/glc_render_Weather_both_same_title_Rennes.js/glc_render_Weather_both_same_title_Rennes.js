...
function glc_render_Weather_both_same_title_Rennes(collection, zone, timeInfo) {
    timeInfo = typeof timeInfo !== 'undefined' ? timeInfo : 5;
    var location = getLocation(collection, zone);
    glc_render_Weather_current_for_main_same_title(collection, zone, location, timeInfo);
    glc_render_Weather_forecast_for_main_same_title(collection, zone, location, timeInfo);
}
