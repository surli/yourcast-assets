 ...
 * - menus_content 
 */
function glc_render_Menus_for_main_short_title(tableau, zone, timeInfo) {
	...
	for (var indice = 0; indice < tableau.length; indice++) {
		...
		content = "<div id='menus' class='main_div_zone1'>";
			content += "<div class='menus_header'>"+contentHeader+"</div>";
