...
// Classe
var ComportementScrollingEachLogoLeft = Class.create(Comportement, {
    /**
    ...
    loop: function() {
        ...
        content = "<div class='scrollContentEachLogoLeft'><span class='scrollContent toLeft' id='scrollcontent_" + this.zone_concerne.id + "'>" + content + "</span></div>";
