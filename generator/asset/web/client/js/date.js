...
/**
 *  Fonction utilis�e pour savoir si la date donn�e se trouve dans une plage 
 *  horaire d'une "pause" / d'une inactivit�. Tous les param�tres peuvent �tre 
 *  des Date ou des Timestamp indiff�remment.
 */
function date_between_date(plage_horaire_debut, plage_horaire_fin, date_tested) {

    // Si un des param�tres n'est pas d�fini
    if(typeof plage_horaire_debut === 'undefined' || typeof plage_horaire_fin === 'undefined' || typeof date_tested === 'undefined') {
        throw new Exception("[moteur/js/date.js] date_between_date", "L'un des param�tres n'est pas d�fini.");
    }
