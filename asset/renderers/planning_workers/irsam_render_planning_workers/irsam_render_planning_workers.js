 ...
 * 
 */
loadLess(LESS_ROOT+"/irsam_render_planning_workers.less");

function irsam_render_planning_workers(datas, zone, timeInfo) {
	...
	rendererContent += "<div class='main_div_zone1 '>";
