  ...
  <body>
    ...
    <div id="container">
      ...
      <table class="principal">
        <tr>  
          <td>
             <p class="message"> Edit the Twitter user information</p>
          </td>  
         </tr>
         <tr> 
           <td>
             <g:form name="twitterEditUserForm" controller="Twitter">
              ...
              <table>
                 ...
                 <tr>
                   ...
                   <td >
                      <g:textField name="user" value="${twitterInfo.userSearch}"/>
                   </td>  
                 </tr>
                 <tr>
                    <td class="basic-label" title="">
                      ...
                      <table>
                        <tr>
                          <td align="center" colspan="2">
                            <g:actionSubmitImage value="Save" action="editUser" src="${resource(dir: 'images/skin', file: 'save.png')}" title="Save"/>  
                          </td>  
                          <td></td>
                          <td></td>
                          <td></td>
